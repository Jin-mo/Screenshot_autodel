...
if platform.system() == "Windows":
    ...
    os.chdir("Change to the directory/location where the file/folder is") # Change to the directory/location where the file/folder is
...
elif cwd == "Location of specified Directory" or cwd == "Location of specified Directory": # Location of specified Directory
    lst = []
